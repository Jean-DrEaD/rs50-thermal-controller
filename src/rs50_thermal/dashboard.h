...
const char DASHBOARD_HTML[] PROGMEM = R"RS50DASH3313(
<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .value { font-size: 2.2em; font-weight: bold; color: #fff; }
...
<body>
  <div class="container">
    ...
    <div class="footer">Firmware <span id="fw">--</span></div>
  </div>
...
<script>
  ...
  var relayEl  = document.getElementById('relay');
  var uptimeEl = document.getElementById('uptime');
  var tempBar  = document.getElementById('tempBar');
  var dutyBar  = document.getElementById('dutyBar');
  ...
  function onWsMessage(ev) {
    try {
      ...
      if (d.fw) fwEl.textContent = 'v' + d.fw;
